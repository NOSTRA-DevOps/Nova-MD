...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "   NOVA-MD WhatsApp Bot Installer  "
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
if [ ! -f .env ]; then
  ...
  echo "# DB_URL=" >> .env
  echo ""
  echo "⚠️  Please edit /root/NOVA-MD/.env with your settings"
  echo "   nano /root/NOVA-MD/.env"
fi
...
echo ""
echo "Next steps:"
echo "  1. Edit your config: nano /root/NOVA-MD/.env"
echo "  2. Start the bot:    cd /root/NOVA-MD && pm2 start index.js --name NOVA-MD"
echo "  3. View logs:        pm2 logs NOVA-MD"
