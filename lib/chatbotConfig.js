import _0x0_0x1905a9 from 'fs';
import _0x0_0x4cd662, { dirname } from 'path';
...
class ChatbotConfig {
    ...
    ['loadConfig']() {
        try {
            if (_0x0_0x1905a9['existsSync'](CONFIG_FILE)) {
                const _0x4c0102 = JSON['parse'](_0x0_0x1905a9['readFileSync'](CONFIG_FILE, 'utf-8'));
                this['config'] = {
                    ...DEFAULT_CONFIG,
                    ..._0x4c0102
                };
            ...
            console['error']('Error\x20loading\x20chatbot\x20config:', _0x10a14c);
            this['config'] = { ...DEFAULT_CONFIG };
        }
        return this['config'];
    }
    ['saveConfig']() {
        try {
            const _0x48a28b = _0x0_0x4cd662['dirname'](CONFIG_FILE);
            if (!_0x0_0x1905a9['existsSync'](_0x48a28b)) {
                _0x0_0x1905a9['mkdirSync'](_0x48a28b, { 'recursive': !![] });
            }
            _0x0_0x1905a9['writeFileSync'](CONFIG_FILE, JSON['stringify'](this['config'], null, 0x2));
            return !![];
        } catch (_0xb6d9c3) {
            console['error']('Error\x20saving\x20chatbot\x20config:', _0xb6d9c3);
            return ![];
        }
    }
    ['get'](_0x502a5c) {
        return this['config'][_0x502a5c];
    }
    ['set'](_0x3a5a6c, _0x2e36d1) {
        this['config'][_0x3a5a6c] = _0x2e36d1;
        this['saveConfig']();
        return this;
    }
    ['getStatus']() {
