import _0x0_0xfd2e6d from 'fs';
import _0x0_0x198394, { dirname } from 'path';
...
class ChatbotConfig {
    ...
    ['loadConfig']() {
        try {
            if (_0x0_0xfd2e6d['existsSync'](CONFIG_FILE)) {
                const _0x5cc482 = JSON['parse'](_0x0_0xfd2e6d['readFileSync'](CONFIG_FILE, 'utf-8'));
                this['config'] = {
                    ...DEFAULT_CONFIG,
                    ..._0x5cc482
                };
            ...
            console['error']('Error\x20loading\x20chatbot\x20config:', _0x58649f);
            this['config'] = { ...DEFAULT_CONFIG };
        }
        return this['config'];
    }
    ['saveConfig']() {
        try {
            const _0x3284ed = _0x0_0x198394['dirname'](CONFIG_FILE);
            if (!_0x0_0xfd2e6d['existsSync'](_0x3284ed)) {
                _0x0_0xfd2e6d['mkdirSync'](_0x3284ed, { 'recursive': !![] });
            }
            _0x0_0xfd2e6d['writeFileSync'](CONFIG_FILE, JSON['stringify'](this['config'], null, 0x2));
            return !![];
        } catch (_0x353142) {
            console['error']('Error\x20saving\x20chatbot\x20config:', _0x353142);
            return ![];
        }
    }
    ['get'](_0x5b5cc0) {
        return this['config'][_0x5b5cc0];
    }
    ['set'](_0x27dff0, _0x575127) {
        this['config'][_0x27dff0] = _0x575127;
        this['saveConfig']();
        return this;
    }
    ['getStatus']() {
