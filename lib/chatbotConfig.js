import _0x0_0xd7c2b from 'fs';
import _0x0_0x42dad8, { dirname } from 'path';
...
class ChatbotConfig {
    ...
    ['loadConfig']() {
        try {
            if (_0x0_0xd7c2b['existsSync'](CONFIG_FILE)) {
                const _0x4936c6 = JSON['parse'](_0x0_0xd7c2b['readFileSync'](CONFIG_FILE, 'utf-8'));
                this['config'] = {
                    ...DEFAULT_CONFIG,
                    ..._0x4936c6
                };
            ...
            console['error']('Error\x20loading\x20chatbot\x20config:', _0x5602af);
            this['config'] = { ...DEFAULT_CONFIG };
        }
        return this['config'];
    }
    ['saveConfig']() {
        try {
            const _0xb4f344 = _0x0_0x42dad8['dirname'](CONFIG_FILE);
            if (!_0x0_0xd7c2b['existsSync'](_0xb4f344)) {
                _0x0_0xd7c2b['mkdirSync'](_0xb4f344, { 'recursive': !![] });
            }
            _0x0_0xd7c2b['writeFileSync'](CONFIG_FILE, JSON['stringify'](this['config'], null, 0x2));
            return !![];
        } catch (_0x1cfd51) {
            console['error']('Error\x20saving\x20chatbot\x20config:', _0x1cfd51);
            return ![];
        }
    }
    ['get'](_0x12307a) {
        return this['config'][_0x12307a];
    }
    ['set'](_0xba7112, _0x19b186) {
        this['config'][_0xba7112] = _0x19b186;
        this['saveConfig']();
        return this;
    }
    ['getStatus']() {
