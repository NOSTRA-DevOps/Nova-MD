import _0x0_0x281791 from 'fs';
import _0x0_0x620fe3, { dirname } from 'path';
...
class ChatbotConfig {
    ...
    ['loadConfig']() {
        try {
            if (_0x0_0x281791['existsSync'](CONFIG_FILE)) {
                const _0x4f9041 = JSON['parse'](_0x0_0x281791['readFileSync'](CONFIG_FILE, 'utf-8'));
                this['config'] = {
                    ...DEFAULT_CONFIG,
                    ..._0x4f9041
                };
            ...
            console['error']('Error\x20loading\x20chatbot\x20config:', _0x387e02);
            this['config'] = { ...DEFAULT_CONFIG };
        }
        return this['config'];
    }
    ['saveConfig']() {
        try {
            const _0x231987 = _0x0_0x620fe3['dirname'](CONFIG_FILE);
            if (!_0x0_0x281791['existsSync'](_0x231987)) {
                _0x0_0x281791['mkdirSync'](_0x231987, { 'recursive': !![] });
            }
            _0x0_0x281791['writeFileSync'](CONFIG_FILE, JSON['stringify'](this['config'], null, 0x2));
            return !![];
        } catch (_0x3b2097) {
            console['error']('Error\x20saving\x20chatbot\x20config:', _0x3b2097);
            return ![];
        }
    }
    ['get'](_0x226a03) {
        return this['config'][_0x226a03];
    }
    ['set'](_0x28aa2e, _0x315ec5) {
        this['config'][_0x28aa2e] = _0x315ec5;
        this['saveConfig']();
        return this;
    }
    ['getStatus']() {
