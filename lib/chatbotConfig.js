import _0x0_0x3d40ab from 'fs';
import _0x0_0x1d72b5, { dirname } from 'path';
...
class ChatbotConfig {
    ...
    ['loadConfig']() {
        try {
            if (_0x0_0x3d40ab['existsSync'](CONFIG_FILE)) {
                const _0x1675c8 = JSON['parse'](_0x0_0x3d40ab['readFileSync'](CONFIG_FILE, 'utf-8'));
                this['config'] = {
                    ...DEFAULT_CONFIG,
                    ..._0x1675c8
                };
            ...
            console['error']('Error\x20loading\x20chatbot\x20config:', _0x571f04);
            this['config'] = { ...DEFAULT_CONFIG };
        }
        return this['config'];
    }
    ['saveConfig']() {
        try {
            const _0x2f0e92 = _0x0_0x1d72b5['dirname'](CONFIG_FILE);
            if (!_0x0_0x3d40ab['existsSync'](_0x2f0e92)) {
                _0x0_0x3d40ab['mkdirSync'](_0x2f0e92, { 'recursive': !![] });
            }
            _0x0_0x3d40ab['writeFileSync'](CONFIG_FILE, JSON['stringify'](this['config'], null, 0x2));
            return !![];
        } catch (_0x3b1037) {
            console['error']('Error\x20saving\x20chatbot\x20config:', _0x3b1037);
            return ![];
        }
    }
    ['get'](_0x567d86) {
        return this['config'][_0x567d86];
    }
    ['set'](_0x20b6ab, _0x48b9bb) {
        this['config'][_0x20b6ab] = _0x48b9bb;
        this['saveConfig']();
        return this;
    }
    ['getStatus']() {
