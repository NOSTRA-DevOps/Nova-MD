import _0x0_0x4667cd from 'fs';
import _0x0_0x2eab4e from 'path';
import { fileURLToPath } from 'url';
import { createRequire } from 'module';
const __filename = fileURLToPath(import.meta.url);
const __dirname = _0x0_0x2eab4e['dirname'](__filename);
const require = createRequire(import.meta.url);
const SESSION_DIR = _0x0_0x2eab4e['join'](process['cwd'](), 'session');
const CREDS_FILE = _0x0_0x2eab4e['join'](SESSION_DIR, 'creds.json');
...
class SessionManager {
    ...
    async ['init']() {
        ...
        try {
            ...
            console['error']('❌\x20Session\x20DB\x20initialization\x20failed:', _0x521a48['message']);
    ...
    async ['initMongoDB']() {
        try {
            const _0x5dbf85 = require('mongoose');
            await _0x5dbf85['connect'](MONGO_URL);
            const _0x34ed2f = new _0x5dbf85['Schema']({
                'sessionId': {
                    'type': String,
                    'unique': !![],
                    'required': !![]
            ...
            this['SessionModel'] = _0x5dbf85['model']('Session', _0x34ed2f);
            this['db'] = this['SessionModel'];
            console['log']('✅\x20MongoDB\x20session\x20storage\x20initialized');
        } catch (_0x2209d3) {
            throw new Error('MongoDB\x20init\x20failed:\x20' + _0x2209d3['message']);
        }
    }
    async ['initPostgreSQL']() {
        try {
            const _0x19ecde = require('pg');
            const {Pool: _0x8ab5a9} = _0x19ecde;
            this['pool'] = new _0x8ab5a9({
            ...
            throw new Error('PostgreSQL\x20init\x20failed:\x20' + _0x192a2d['message']);
        }
    }
    async ['initMySQL']() {
        try {
            const _0x14d1f6 = require('mysql2/promise');
            this['mysqlConn'] = await _0x14d1f6['createConnection'](MYSQL_URL);
            ...
            throw new Error('MySQL\x20init\x20failed:\x20' + _0x103ac7['message']);
        }
    }
    async ['saveSession'](_0x39d607, _0x53716b = null) {
        await this['init']();
        const _0x516c21 = this['generateSessionId']();
        const _0x57b7d1 = _0x39d607['registered'] === !![] || !!_0x39d607['me']?.['id'];
        this['saveLocal'](_0x39d607);
        try {
            if (this['dbType'] === 'mongodb' && this['db']) {
                await this['db']['updateOne']({ 'sessionId': _0x516c21 }, {
                    'sessionId': _0x516c21,
                    'creds': _0x39d607,
                    'registered': _0x57b7d1,
                    'phoneNumber': _0x53716b,
                    'deviceId': _0x39d607['deviceId'] || null,
                    'updatedAt': new Date()
                }, { 'upsert': !![] });
                console['log']('✅\x20Session\x20saved\x20to\x20MongoDB:\x20' + _0x516c21);
                ...
                await this['pool']['query']('INSERT\x20INTO\x20sessions\x20(session_id,\x20creds,\x20registered,\x20phone_number,\x20device_id,\x20updated_at)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20VALUES\x20($1,\x20$2,\x20$3,\x20$4,\x20$5,\x20CURRENT_TIMESTAMP)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20ON\x20CONFLICT\x20(session_id)\x20DO\x20UPDATE\x20SET\x20\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20creds\x20=\x20EXCLUDED.creds,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20registered\x20=\x20EXCLUDED.registered,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20phone_number\x20=\x20EXCLUDED.phone_number,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20device_id\x20=\x20EXCLUDED.device_id,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20updated_at\x20=\x20CURRENT_TIMESTAMP', [
                    ...
                    _0x57b7d1,
                    _0x53716b,
                    _0x39d607['deviceId'] || null
                ]);
                console['log']('✅\x20Session\x20saved\x20to\x20PostgreSQL:\x20' + _0x516c21);
                ...
                await this['mysqlConn']['execute']('INSERT\x20INTO\x20sessions\x20(session_id,\x20creds,\x20registered,\x20phone_number,\x20device_id,\x20updated_at)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20VALUES\x20(?,\x20?,\x20?,\x20?,\x20?,\x20CURRENT_TIMESTAMP)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20ON\x20DUPLICATE\x20KEY\x20UPDATE\x20\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20creds\x20=\x20VALUES(creds),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20registered\x20=\x20VALUES(registered),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20phone_number\x20=\x20VALUES(phone_number),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20device_id\x20=\x20VALUES(device_id),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20updated_at\x20=\x20CURRENT_TIMESTAMP', [
                    _0x516c21,
                    JSON['stringify'](_0x39d607),
                    _0x57b7d1,
                    _0x53716b,
                    _0x39d607['deviceId'] || null
                ]);
                console['log']('✅\x20Session\x20saved\x20to\x20MySQL:\x20' + _0x516c21);
            }
        } catch (_0x32498d) {
            console['error']('❌\x20DB\x20session\x20save\x20failed:', _0x32498d['message']);
        }
        return _0x516c21;
    }
    async ['loadSession']() {
        ...
        try {
            if (this['dbType'] === 'mongodb' && this['db']) {
                const _0x934e16 = await this['db']['findOne']({ 'registered': !![] })['sort']({ 'updatedAt': -0x1 });
                if (_0x934e16) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20MongoDB:\x20' + _0x934e16['sessionId']);
                    this['saveLocal'](_0x934e16['creds']);
                    return _0x934e16['creds'];
                }
            } else if (this['dbType'] === 'postgresql' && this['pool']) {
                const _0x27aba5 = await this['pool']['query']('SELECT\x20session_id,\x20creds\x20FROM\x20sessions\x20WHERE\x20registered\x20=\x20true\x20ORDER\x20BY\x20updated_at\x20DESC\x20LIMIT\x201');
                if (_0x27aba5['rows']['length'] > 0x0) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20PostgreSQL:\x20' + _0x27aba5['rows'][0x0]['session_id']);
                    this['saveLocal'](_0x27aba5['rows'][0x0]['creds']);
                    return _0x27aba5['rows'][0x0]['creds'];
                }
            } else if (this['dbType'] === 'mysql' && this['mysqlConn']) {
                const [_0xbf7ecc] = await this['mysqlConn']['execute']('SELECT\x20session_id,\x20creds\x20FROM\x20sessions\x20WHERE\x20registered\x20=\x20true\x20ORDER\x20BY\x20updated_at\x20DESC\x20LIMIT\x201');
                if (_0xbf7ecc['length'] > 0x0) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20MySQL:\x20' + _0xbf7ecc[0x0]['session_id']);
                    this['saveLocal'](_0xbf7ecc[0x0]['creds']);
                    return _0xbf7ecc[0x0]['creds'];
                }
            }
        } catch (_0x2552fa) {
            console['error']('❌\x20DB\x20session\x20load\x20failed:', _0x2552fa['message']);
        }
        const _0x2dcc9e = this['loadLocal']();
        if (_0x2dcc9e) {
    ...
    ['saveLocal'](_0x23be96) {
        try {
            if (!_0x0_0x4667cd['existsSync'](SESSION_DIR)) {
                _0x0_0x4667cd['mkdirSync'](SESSION_DIR, { 'recursive': !![] });
            }
            _0x0_0x4667cd['writeFileSync'](CREDS_FILE, JSON['stringify'](_0x23be96, null, 0x2));
            return !![];
        } catch (_0x2f2a76) {
            console['error']('❌\x20Local\x20save\x20failed:', _0x2f2a76['message']);
            return ![];
        }
    }
    ['loadLocal']() {
        try {
            if (_0x0_0x4667cd['existsSync'](CREDS_FILE)) {
                return JSON['parse'](_0x0_0x4667cd['readFileSync'](CREDS_FILE, 'utf-8'));
            }
            return null;
        } catch (_0x3ba4dc) {
            console['error']('❌\x20Local\x20load\x20failed:', _0x3ba4dc['message']);
            return null;
        }
    }
    ['generateSessionId']() {
        const _0x56ea42 = 'abcdefghijklmnopqrstuvwxyz0123456789';
        const _0x545df4 = Array['from']({ 'length': 0x6 }, () => _0x56ea42[Math['floor'](Math['random']() * _0x56ea42['length'])])['join']('');
        const _0x11fc2e = String(Math['floor'](Math['random']() * 0x2710))['padStart'](0x4, '0');
        return 'NOVA-' + _0x545df4 + _0x11fc2e;
    }
    ['hasValidSession']() {
        try {
            const _0x3440c8 = this['loadLocal']();
            if (!_0x3440c8)
                return ![];
            if (!_0x3440c8['noiseKey'] || !_0x3440c8['signedIdentityKey'] || !_0x3440c8['signedPreKey']) {
                return ![];
            }
            if (_0x3440c8['registered'] !== !![] && !_0x3440c8['me']?.['id']) {
                return ![];
            }
            return !![];
        } catch (_0x1113bf) {
    ...
    async ['deleteSession']() {
        try {
            ...
            console['error']('❌\x20DB\x20delete\x20failed:', _0x56e60e['message']);
        }
        try {
            if (_0x0_0x4667cd['existsSync'](CREDS_FILE)) {
                _0x0_0x4667cd['unlinkSync'](CREDS_FILE);
                console['log']('🗑️\x20Local\x20session\x20deleted');
            }
        } catch (_0x5bd024) {
            console['error']('❌\x20Local\x20delete\x20failed:', _0x5bd024['message']);
        }
    }
    async ['close']() {
        try {
            if (this['dbType'] === 'mongodb') {
                const _0x4f6994 = require('mongoose');
                await _0x4f6994['connection']['close']();
            } else if (this['dbType'] === 'postgresql' && this['pool']) {
                await this['pool']['end']();
            } else if (this['dbType'] === 'mysql' && this['mysqlConn']) {
            ...
            console['error']('❌\x20Close\x20failed:', _0x5826b7['message']);
        }
    }
}
