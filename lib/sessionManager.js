import _0x0_0x4e5e5c from 'fs';
import _0x0_0x1fbe99 from 'path';
import { fileURLToPath } from 'url';
import { createRequire } from 'module';
const __filename = fileURLToPath(import.meta.url);
const __dirname = _0x0_0x1fbe99['dirname'](__filename);
const require = createRequire(import.meta.url);
const SESSION_DIR = _0x0_0x1fbe99['join'](process['cwd'](), 'session');
const CREDS_FILE = _0x0_0x1fbe99['join'](SESSION_DIR, 'creds.json');
...
class SessionManager {
    ...
    async ['init']() {
        ...
        try {
            ...
            console['error']('❌\x20Session\x20DB\x20initialization\x20failed:', _0x4d3d2b['message']);
    ...
    async ['initMongoDB']() {
        try {
            const _0x3c3fe4 = require('mongoose');
            await _0x3c3fe4['connect'](MONGO_URL);
            const _0x29e9cf = new _0x3c3fe4['Schema']({
                'sessionId': {
                    'type': String,
                    'unique': !![],
                    'required': !![]
            ...
            this['SessionModel'] = _0x3c3fe4['model']('Session', _0x29e9cf);
            this['db'] = this['SessionModel'];
            console['log']('✅\x20MongoDB\x20session\x20storage\x20initialized');
        } catch (_0x25f0a1) {
            throw new Error('MongoDB\x20init\x20failed:\x20' + _0x25f0a1['message']);
        }
    }
    async ['initPostgreSQL']() {
        try {
            const _0x26d5d5 = require('pg');
            const {Pool: _0x1eccb6} = _0x26d5d5;
            this['pool'] = new _0x1eccb6({
            ...
            throw new Error('PostgreSQL\x20init\x20failed:\x20' + _0x3fec41['message']);
        }
    }
    async ['initMySQL']() {
        try {
            const _0x2799d3 = require('mysql2/promise');
            this['mysqlConn'] = await _0x2799d3['createConnection'](MYSQL_URL);
            ...
            throw new Error('MySQL\x20init\x20failed:\x20' + _0x813619['message']);
        }
    }
    async ['saveSession'](_0x3c6656, _0x28ad11 = null) {
        await this['init']();
        const _0xda40b9 = this['generateSessionId']();
        const _0x586381 = _0x3c6656['registered'] === !![] || !!_0x3c6656['me']?.['id'];
        this['saveLocal'](_0x3c6656);
        try {
            if (this['dbType'] === 'mongodb' && this['db']) {
                await this['db']['updateOne']({ 'sessionId': _0xda40b9 }, {
                    'sessionId': _0xda40b9,
                    'creds': _0x3c6656,
                    'registered': _0x586381,
                    'phoneNumber': _0x28ad11,
                    'deviceId': _0x3c6656['deviceId'] || null,
                    'updatedAt': new Date()
                }, { 'upsert': !![] });
                console['log']('✅\x20Session\x20saved\x20to\x20MongoDB:\x20' + _0xda40b9);
                ...
                await this['pool']['query']('INSERT\x20INTO\x20sessions\x20(session_id,\x20creds,\x20registered,\x20phone_number,\x20device_id,\x20updated_at)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20VALUES\x20($1,\x20$2,\x20$3,\x20$4,\x20$5,\x20CURRENT_TIMESTAMP)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20ON\x20CONFLICT\x20(session_id)\x20DO\x20UPDATE\x20SET\x20\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20creds\x20=\x20EXCLUDED.creds,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20registered\x20=\x20EXCLUDED.registered,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20phone_number\x20=\x20EXCLUDED.phone_number,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20device_id\x20=\x20EXCLUDED.device_id,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20updated_at\x20=\x20CURRENT_TIMESTAMP', [
                    ...
                    _0x586381,
                    _0x28ad11,
                    _0x3c6656['deviceId'] || null
                ]);
                console['log']('✅\x20Session\x20saved\x20to\x20PostgreSQL:\x20' + _0xda40b9);
                ...
                await this['mysqlConn']['execute']('INSERT\x20INTO\x20sessions\x20(session_id,\x20creds,\x20registered,\x20phone_number,\x20device_id,\x20updated_at)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20VALUES\x20(?,\x20?,\x20?,\x20?,\x20?,\x20CURRENT_TIMESTAMP)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20ON\x20DUPLICATE\x20KEY\x20UPDATE\x20\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20creds\x20=\x20VALUES(creds),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20registered\x20=\x20VALUES(registered),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20phone_number\x20=\x20VALUES(phone_number),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20device_id\x20=\x20VALUES(device_id),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20updated_at\x20=\x20CURRENT_TIMESTAMP', [
                    _0xda40b9,
                    JSON['stringify'](_0x3c6656),
                    _0x586381,
                    _0x28ad11,
                    _0x3c6656['deviceId'] || null
                ]);
                console['log']('✅\x20Session\x20saved\x20to\x20MySQL:\x20' + _0xda40b9);
            }
        } catch (_0x29037d) {
            console['error']('❌\x20DB\x20session\x20save\x20failed:', _0x29037d['message']);
        }
        return _0xda40b9;
    }
    async ['loadSession']() {
        ...
        try {
            if (this['dbType'] === 'mongodb' && this['db']) {
                const _0xa47aef = await this['db']['findOne']({ 'registered': !![] })['sort']({ 'updatedAt': -0x1 });
                if (_0xa47aef) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20MongoDB:\x20' + _0xa47aef['sessionId']);
                    this['saveLocal'](_0xa47aef['creds']);
                    return _0xa47aef['creds'];
                }
            } else if (this['dbType'] === 'postgresql' && this['pool']) {
                const _0x25d9db = await this['pool']['query']('SELECT\x20session_id,\x20creds\x20FROM\x20sessions\x20WHERE\x20registered\x20=\x20true\x20ORDER\x20BY\x20updated_at\x20DESC\x20LIMIT\x201');
                if (_0x25d9db['rows']['length'] > 0x0) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20PostgreSQL:\x20' + _0x25d9db['rows'][0x0]['session_id']);
                    this['saveLocal'](_0x25d9db['rows'][0x0]['creds']);
                    return _0x25d9db['rows'][0x0]['creds'];
                }
            } else if (this['dbType'] === 'mysql' && this['mysqlConn']) {
                const [_0x34f821] = await this['mysqlConn']['execute']('SELECT\x20session_id,\x20creds\x20FROM\x20sessions\x20WHERE\x20registered\x20=\x20true\x20ORDER\x20BY\x20updated_at\x20DESC\x20LIMIT\x201');
                if (_0x34f821['length'] > 0x0) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20MySQL:\x20' + _0x34f821[0x0]['session_id']);
                    this['saveLocal'](_0x34f821[0x0]['creds']);
                    return _0x34f821[0x0]['creds'];
                }
            }
        } catch (_0x5a92c4) {
            console['error']('❌\x20DB\x20session\x20load\x20failed:', _0x5a92c4['message']);
        }
        const _0x2d5d63 = this['loadLocal']();
        if (_0x2d5d63) {
    ...
    ['saveLocal'](_0x316f1e) {
        try {
            if (!_0x0_0x4e5e5c['existsSync'](SESSION_DIR)) {
                _0x0_0x4e5e5c['mkdirSync'](SESSION_DIR, { 'recursive': !![] });
            }
            _0x0_0x4e5e5c['writeFileSync'](CREDS_FILE, JSON['stringify'](_0x316f1e, null, 0x2));
            return !![];
        } catch (_0xaa7258) {
            console['error']('❌\x20Local\x20save\x20failed:', _0xaa7258['message']);
            return ![];
        }
    }
    ['loadLocal']() {
        try {
            if (_0x0_0x4e5e5c['existsSync'](CREDS_FILE)) {
                return JSON['parse'](_0x0_0x4e5e5c['readFileSync'](CREDS_FILE, 'utf-8'));
            }
            return null;
        } catch (_0xc2f5fc) {
            console['error']('❌\x20Local\x20load\x20failed:', _0xc2f5fc['message']);
            return null;
        }
    }
    ['generateSessionId']() {
        const _0x37d433 = 'abcdefghijklmnopqrstuvwxyz0123456789';
        const _0x788b84 = Array['from']({ 'length': 0x6 }, () => _0x37d433[Math['floor'](Math['random']() * _0x37d433['length'])])['join']('');
        const _0x199faa = String(Math['floor'](Math['random']() * 0x2710))['padStart'](0x4, '0');
        return 'NOVA-' + _0x788b84 + _0x199faa;
    }
    ['hasValidSession']() {
        try {
            const _0x1d332e = this['loadLocal']();
            if (!_0x1d332e)
                return ![];
            if (!_0x1d332e['noiseKey'] || !_0x1d332e['signedIdentityKey'] || !_0x1d332e['signedPreKey']) {
                return ![];
            }
            if (_0x1d332e['registered'] !== !![] && !_0x1d332e['me']?.['id']) {
                return ![];
            }
            return !![];
        } catch (_0x14f576) {
    ...
    async ['deleteSession']() {
        try {
            ...
            console['error']('❌\x20DB\x20delete\x20failed:', _0x5b258a['message']);
        }
        try {
            if (_0x0_0x4e5e5c['existsSync'](CREDS_FILE)) {
                _0x0_0x4e5e5c['unlinkSync'](CREDS_FILE);
                console['log']('🗑️\x20Local\x20session\x20deleted');
            }
        } catch (_0x411b45) {
            console['error']('❌\x20Local\x20delete\x20failed:', _0x411b45['message']);
        }
    }
    async ['close']() {
        try {
            if (this['dbType'] === 'mongodb') {
                const _0x50ae63 = require('mongoose');
                await _0x50ae63['connection']['close']();
            } else if (this['dbType'] === 'postgresql' && this['pool']) {
                await this['pool']['end']();
            } else if (this['dbType'] === 'mysql' && this['mysqlConn']) {
            ...
            console['error']('❌\x20Close\x20failed:', _0x1cdbb6['message']);
        }
    }
}
