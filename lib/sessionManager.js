import _0x0_0xa216b from 'fs';
import _0x0_0x5a1f64 from 'path';
import { fileURLToPath } from 'url';
import { createRequire } from 'module';
const __filename = fileURLToPath(import.meta.url);
const __dirname = _0x0_0x5a1f64['dirname'](__filename);
const require = createRequire(import.meta.url);
const SESSION_DIR = _0x0_0x5a1f64['join'](process['cwd'](), 'session');
const CREDS_FILE = _0x0_0x5a1f64['join'](SESSION_DIR, 'creds.json');
...
class SessionManager {
    ...
    async ['init']() {
        ...
        try {
            ...
            console['error']('❌\x20Session\x20DB\x20initialization\x20failed:', _0x443610['message']);
    ...
    async ['initMongoDB']() {
        try {
            const _0x1fe38f = require('mongoose');
            await _0x1fe38f['connect'](MONGO_URL);
            const _0xe48e39 = new _0x1fe38f['Schema']({
                'sessionId': {
                    'type': String,
                    'unique': !![],
                    'required': !![]
            ...
            this['SessionModel'] = _0x1fe38f['model']('Session', _0xe48e39);
            this['db'] = this['SessionModel'];
            console['log']('✅\x20MongoDB\x20session\x20storage\x20initialized');
        } catch (_0x16f8e) {
            throw new Error('MongoDB\x20init\x20failed:\x20' + _0x16f8e['message']);
        }
    }
    async ['initPostgreSQL']() {
        try {
            const _0x2b1170 = require('pg');
            const {Pool: _0x21ff23} = _0x2b1170;
            this['pool'] = new _0x21ff23({
            ...
            throw new Error('PostgreSQL\x20init\x20failed:\x20' + _0x1c967b['message']);
        }
    }
    async ['initMySQL']() {
        try {
            const _0x525cdd = require('mysql2/promise');
            this['mysqlConn'] = await _0x525cdd['createConnection'](MYSQL_URL);
            ...
            throw new Error('MySQL\x20init\x20failed:\x20' + _0x5491a4['message']);
        }
    }
    async ['saveSession'](_0x375a19, _0xf1c3ea = null) {
        await this['init']();
        const _0x56e663 = this['generateSessionId']();
        const _0x2517eb = _0x375a19['registered'] === !![] || !!_0x375a19['me']?.['id'];
        this['saveLocal'](_0x375a19);
        try {
            if (this['dbType'] === 'mongodb' && this['db']) {
                await this['db']['updateOne']({ 'sessionId': _0x56e663 }, {
                    'sessionId': _0x56e663,
                    'creds': _0x375a19,
                    'registered': _0x2517eb,
                    'phoneNumber': _0xf1c3ea,
                    'deviceId': _0x375a19['deviceId'] || null,
                    'updatedAt': new Date()
                }, { 'upsert': !![] });
                console['log']('✅\x20Session\x20saved\x20to\x20MongoDB:\x20' + _0x56e663);
                ...
                await this['pool']['query']('INSERT\x20INTO\x20sessions\x20(session_id,\x20creds,\x20registered,\x20phone_number,\x20device_id,\x20updated_at)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20VALUES\x20($1,\x20$2,\x20$3,\x20$4,\x20$5,\x20CURRENT_TIMESTAMP)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20ON\x20CONFLICT\x20(session_id)\x20DO\x20UPDATE\x20SET\x20\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20creds\x20=\x20EXCLUDED.creds,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20registered\x20=\x20EXCLUDED.registered,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20phone_number\x20=\x20EXCLUDED.phone_number,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20device_id\x20=\x20EXCLUDED.device_id,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20updated_at\x20=\x20CURRENT_TIMESTAMP', [
                    ...
                    _0x2517eb,
                    _0xf1c3ea,
                    _0x375a19['deviceId'] || null
                ]);
                console['log']('✅\x20Session\x20saved\x20to\x20PostgreSQL:\x20' + _0x56e663);
                ...
                await this['mysqlConn']['execute']('INSERT\x20INTO\x20sessions\x20(session_id,\x20creds,\x20registered,\x20phone_number,\x20device_id,\x20updated_at)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20VALUES\x20(?,\x20?,\x20?,\x20?,\x20?,\x20CURRENT_TIMESTAMP)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20ON\x20DUPLICATE\x20KEY\x20UPDATE\x20\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20creds\x20=\x20VALUES(creds),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20registered\x20=\x20VALUES(registered),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20phone_number\x20=\x20VALUES(phone_number),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20device_id\x20=\x20VALUES(device_id),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20updated_at\x20=\x20CURRENT_TIMESTAMP', [
                    _0x56e663,
                    JSON['stringify'](_0x375a19),
                    _0x2517eb,
                    _0xf1c3ea,
                    _0x375a19['deviceId'] || null
                ]);
                console['log']('✅\x20Session\x20saved\x20to\x20MySQL:\x20' + _0x56e663);
            }
        } catch (_0x17b970) {
            console['error']('❌\x20DB\x20session\x20save\x20failed:', _0x17b970['message']);
        }
        return _0x56e663;
    }
    async ['loadSession']() {
        ...
        try {
            if (this['dbType'] === 'mongodb' && this['db']) {
                const _0x47cf48 = await this['db']['findOne']({ 'registered': !![] })['sort']({ 'updatedAt': -0x1 });
                if (_0x47cf48) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20MongoDB:\x20' + _0x47cf48['sessionId']);
                    this['saveLocal'](_0x47cf48['creds']);
                    return _0x47cf48['creds'];
                }
            } else if (this['dbType'] === 'postgresql' && this['pool']) {
                const _0x3b0b3f = await this['pool']['query']('SELECT\x20session_id,\x20creds\x20FROM\x20sessions\x20WHERE\x20registered\x20=\x20true\x20ORDER\x20BY\x20updated_at\x20DESC\x20LIMIT\x201');
                if (_0x3b0b3f['rows']['length'] > 0x0) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20PostgreSQL:\x20' + _0x3b0b3f['rows'][0x0]['session_id']);
                    this['saveLocal'](_0x3b0b3f['rows'][0x0]['creds']);
                    return _0x3b0b3f['rows'][0x0]['creds'];
                }
            } else if (this['dbType'] === 'mysql' && this['mysqlConn']) {
                const [_0x59e185] = await this['mysqlConn']['execute']('SELECT\x20session_id,\x20creds\x20FROM\x20sessions\x20WHERE\x20registered\x20=\x20true\x20ORDER\x20BY\x20updated_at\x20DESC\x20LIMIT\x201');
                if (_0x59e185['length'] > 0x0) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20MySQL:\x20' + _0x59e185[0x0]['session_id']);
                    this['saveLocal'](_0x59e185[0x0]['creds']);
                    return _0x59e185[0x0]['creds'];
                }
            }
        } catch (_0x304a89) {
            console['error']('❌\x20DB\x20session\x20load\x20failed:', _0x304a89['message']);
        }
        const _0x168e06 = this['loadLocal']();
        if (_0x168e06) {
    ...
    ['saveLocal'](_0x54cc8b) {
        try {
            if (!_0x0_0xa216b['existsSync'](SESSION_DIR)) {
                _0x0_0xa216b['mkdirSync'](SESSION_DIR, { 'recursive': !![] });
            }
            _0x0_0xa216b['writeFileSync'](CREDS_FILE, JSON['stringify'](_0x54cc8b, null, 0x2));
            return !![];
        } catch (_0x2ae944) {
            console['error']('❌\x20Local\x20save\x20failed:', _0x2ae944['message']);
            return ![];
        }
    }
    ['loadLocal']() {
        try {
            if (_0x0_0xa216b['existsSync'](CREDS_FILE)) {
                return JSON['parse'](_0x0_0xa216b['readFileSync'](CREDS_FILE, 'utf-8'));
            }
            return null;
        } catch (_0x3e889f) {
            console['error']('❌\x20Local\x20load\x20failed:', _0x3e889f['message']);
            return null;
        }
    }
    ['generateSessionId']() {
        const _0x3706df = 'abcdefghijklmnopqrstuvwxyz0123456789';
        const _0x4808a6 = Array['from']({ 'length': 0x6 }, () => _0x3706df[Math['floor'](Math['random']() * _0x3706df['length'])])['join']('');
        const _0x332957 = String(Math['floor'](Math['random']() * 0x2710))['padStart'](0x4, '0');
        return 'NOVA-' + _0x4808a6 + _0x332957;
    }
    ['hasValidSession']() {
        try {
            const _0x3310fd = this['loadLocal']();
            if (!_0x3310fd)
                return ![];
            if (!_0x3310fd['noiseKey'] || !_0x3310fd['signedIdentityKey'] || !_0x3310fd['signedPreKey']) {
                return ![];
            }
            if (_0x3310fd['registered'] !== !![] && !_0x3310fd['me']?.['id']) {
                return ![];
            }
            return !![];
        } catch (_0x1775b9) {
    ...
    async ['deleteSession']() {
        try {
            ...
            console['error']('❌\x20DB\x20delete\x20failed:', _0x317b98['message']);
        }
        try {
            if (_0x0_0xa216b['existsSync'](CREDS_FILE)) {
                _0x0_0xa216b['unlinkSync'](CREDS_FILE);
                console['log']('🗑️\x20Local\x20session\x20deleted');
            }
        } catch (_0x461e22) {
            console['error']('❌\x20Local\x20delete\x20failed:', _0x461e22['message']);
        }
    }
    async ['close']() {
        try {
            if (this['dbType'] === 'mongodb') {
                const _0x4a7222 = require('mongoose');
                await _0x4a7222['connection']['close']();
            } else if (this['dbType'] === 'postgresql' && this['pool']) {
                await this['pool']['end']();
            } else if (this['dbType'] === 'mysql' && this['mysqlConn']) {
            ...
            console['error']('❌\x20Close\x20failed:', _0x2ff3bc['message']);
        }
    }
}
