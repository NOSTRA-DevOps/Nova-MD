import _0x0_0x529551 from 'fs';
import _0x0_0x2cef51 from 'path';
import { fileURLToPath } from 'url';
import { createRequire } from 'module';
const __filename = fileURLToPath(import.meta.url);
const __dirname = _0x0_0x2cef51['dirname'](__filename);
const require = createRequire(import.meta.url);
const SESSION_DIR = _0x0_0x2cef51['join'](process['cwd'](), 'session');
const CREDS_FILE = _0x0_0x2cef51['join'](SESSION_DIR, 'creds.json');
...
class SessionManager {
    ...
    async ['init']() {
        ...
        try {
            ...
            console['error']('❌\x20Session\x20DB\x20initialization\x20failed:', _0x56c4d6['message']);
    ...
    async ['initMongoDB']() {
        try {
            const _0xc02af4 = require('mongoose');
            await _0xc02af4['connect'](MONGO_URL);
            const _0x30bc20 = new _0xc02af4['Schema']({
                'sessionId': {
                    'type': String,
                    'unique': !![],
                    'required': !![]
            ...
            this['SessionModel'] = _0xc02af4['model']('Session', _0x30bc20);
            this['db'] = this['SessionModel'];
            console['log']('✅\x20MongoDB\x20session\x20storage\x20initialized');
        } catch (_0x4bbd76) {
            throw new Error('MongoDB\x20init\x20failed:\x20' + _0x4bbd76['message']);
        }
    }
    async ['initPostgreSQL']() {
        try {
            const _0x437b37 = require('pg');
            const {Pool: _0x55776b} = _0x437b37;
            this['pool'] = new _0x55776b({
            ...
            throw new Error('PostgreSQL\x20init\x20failed:\x20' + _0x1127b0['message']);
        }
    }
    async ['initMySQL']() {
        try {
            const _0x5ab995 = require('mysql2/promise');
            this['mysqlConn'] = await _0x5ab995['createConnection'](MYSQL_URL);
            ...
            throw new Error('MySQL\x20init\x20failed:\x20' + _0x11b9d2['message']);
        }
    }
    async ['saveSession'](_0x13aeaf, _0x20cb69 = null) {
        await this['init']();
        const _0x20f144 = this['generateSessionId']();
        const _0x15a5f9 = _0x13aeaf['registered'] === !![] || !!_0x13aeaf['me']?.['id'];
        this['saveLocal'](_0x13aeaf);
        try {
            if (this['dbType'] === 'mongodb' && this['db']) {
                await this['db']['updateOne']({ 'sessionId': _0x20f144 }, {
                    'sessionId': _0x20f144,
                    'creds': _0x13aeaf,
                    'registered': _0x15a5f9,
                    'phoneNumber': _0x20cb69,
                    'deviceId': _0x13aeaf['deviceId'] || null,
                    'updatedAt': new Date()
                }, { 'upsert': !![] });
                console['log']('✅\x20Session\x20saved\x20to\x20MongoDB:\x20' + _0x20f144);
                ...
                await this['pool']['query']('INSERT\x20INTO\x20sessions\x20(session_id,\x20creds,\x20registered,\x20phone_number,\x20device_id,\x20updated_at)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20VALUES\x20($1,\x20$2,\x20$3,\x20$4,\x20$5,\x20CURRENT_TIMESTAMP)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20ON\x20CONFLICT\x20(session_id)\x20DO\x20UPDATE\x20SET\x20\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20creds\x20=\x20EXCLUDED.creds,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20registered\x20=\x20EXCLUDED.registered,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20phone_number\x20=\x20EXCLUDED.phone_number,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20device_id\x20=\x20EXCLUDED.device_id,\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20updated_at\x20=\x20CURRENT_TIMESTAMP', [
                    ...
                    _0x15a5f9,
                    _0x20cb69,
                    _0x13aeaf['deviceId'] || null
                ]);
                console['log']('✅\x20Session\x20saved\x20to\x20PostgreSQL:\x20' + _0x20f144);
                ...
                await this['mysqlConn']['execute']('INSERT\x20INTO\x20sessions\x20(session_id,\x20creds,\x20registered,\x20phone_number,\x20device_id,\x20updated_at)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20VALUES\x20(?,\x20?,\x20?,\x20?,\x20?,\x20CURRENT_TIMESTAMP)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20ON\x20DUPLICATE\x20KEY\x20UPDATE\x20\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20creds\x20=\x20VALUES(creds),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20registered\x20=\x20VALUES(registered),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20phone_number\x20=\x20VALUES(phone_number),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20device_id\x20=\x20VALUES(device_id),\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20updated_at\x20=\x20CURRENT_TIMESTAMP', [
                    _0x20f144,
                    JSON['stringify'](_0x13aeaf),
                    _0x15a5f9,
                    _0x20cb69,
                    _0x13aeaf['deviceId'] || null
                ]);
                console['log']('✅\x20Session\x20saved\x20to\x20MySQL:\x20' + _0x20f144);
            }
        } catch (_0x38d3e4) {
            console['error']('❌\x20DB\x20session\x20save\x20failed:', _0x38d3e4['message']);
        }
        return _0x20f144;
    }
    async ['loadSession']() {
        ...
        try {
            if (this['dbType'] === 'mongodb' && this['db']) {
                const _0x3b8743 = await this['db']['findOne']({ 'registered': !![] })['sort']({ 'updatedAt': -0x1 });
                if (_0x3b8743) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20MongoDB:\x20' + _0x3b8743['sessionId']);
                    this['saveLocal'](_0x3b8743['creds']);
                    return _0x3b8743['creds'];
                }
            } else if (this['dbType'] === 'postgresql' && this['pool']) {
                const _0x2e25fc = await this['pool']['query']('SELECT\x20session_id,\x20creds\x20FROM\x20sessions\x20WHERE\x20registered\x20=\x20true\x20ORDER\x20BY\x20updated_at\x20DESC\x20LIMIT\x201');
                if (_0x2e25fc['rows']['length'] > 0x0) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20PostgreSQL:\x20' + _0x2e25fc['rows'][0x0]['session_id']);
                    this['saveLocal'](_0x2e25fc['rows'][0x0]['creds']);
                    return _0x2e25fc['rows'][0x0]['creds'];
                }
            } else if (this['dbType'] === 'mysql' && this['mysqlConn']) {
                const [_0x1ad137] = await this['mysqlConn']['execute']('SELECT\x20session_id,\x20creds\x20FROM\x20sessions\x20WHERE\x20registered\x20=\x20true\x20ORDER\x20BY\x20updated_at\x20DESC\x20LIMIT\x201');
                if (_0x1ad137['length'] > 0x0) {
                    console['log']('✅\x20Session\x20loaded\x20from\x20MySQL:\x20' + _0x1ad137[0x0]['session_id']);
                    this['saveLocal'](_0x1ad137[0x0]['creds']);
                    return _0x1ad137[0x0]['creds'];
                }
            }
        } catch (_0x2a8c21) {
            console['error']('❌\x20DB\x20session\x20load\x20failed:', _0x2a8c21['message']);
        }
        const _0x493682 = this['loadLocal']();
        if (_0x493682) {
    ...
    ['saveLocal'](_0x4b5910) {
        try {
            if (!_0x0_0x529551['existsSync'](SESSION_DIR)) {
                _0x0_0x529551['mkdirSync'](SESSION_DIR, { 'recursive': !![] });
            }
            _0x0_0x529551['writeFileSync'](CREDS_FILE, JSON['stringify'](_0x4b5910, null, 0x2));
            return !![];
        } catch (_0x8a85d4) {
            console['error']('❌\x20Local\x20save\x20failed:', _0x8a85d4['message']);
            return ![];
        }
    }
    ['loadLocal']() {
        try {
            if (_0x0_0x529551['existsSync'](CREDS_FILE)) {
                return JSON['parse'](_0x0_0x529551['readFileSync'](CREDS_FILE, 'utf-8'));
            }
            return null;
        } catch (_0x650bca) {
            console['error']('❌\x20Local\x20load\x20failed:', _0x650bca['message']);
            return null;
        }
    }
    ['generateSessionId']() {
        const _0x1f1efe = 'abcdefghijklmnopqrstuvwxyz0123456789';
        const _0x9b0a92 = Array['from']({ 'length': 0x6 }, () => _0x1f1efe[Math['floor'](Math['random']() * _0x1f1efe['length'])])['join']('');
        const _0x5869b9 = String(Math['floor'](Math['random']() * 0x2710))['padStart'](0x4, '0');
        return 'NOVA-' + _0x9b0a92 + _0x5869b9;
    }
    ['hasValidSession']() {
        try {
            const _0x53b7e2 = this['loadLocal']();
            if (!_0x53b7e2)
                return ![];
            if (!_0x53b7e2['noiseKey'] || !_0x53b7e2['signedIdentityKey'] || !_0x53b7e2['signedPreKey']) {
                return ![];
            }
            if (_0x53b7e2['registered'] !== !![] && !_0x53b7e2['me']?.['id']) {
                return ![];
            }
            return !![];
        } catch (_0x5b7b8b) {
    ...
    async ['deleteSession']() {
        try {
            ...
            console['error']('❌\x20DB\x20delete\x20failed:', _0x25ea37['message']);
        }
        try {
            if (_0x0_0x529551['existsSync'](CREDS_FILE)) {
                _0x0_0x529551['unlinkSync'](CREDS_FILE);
                console['log']('🗑️\x20Local\x20session\x20deleted');
            }
        } catch (_0x5112ff) {
            console['error']('❌\x20Local\x20delete\x20failed:', _0x5112ff['message']);
        }
    }
    async ['close']() {
        try {
            if (this['dbType'] === 'mongodb') {
                const _0x53010f = require('mongoose');
                await _0x53010f['connection']['close']();
            } else if (this['dbType'] === 'postgresql' && this['pool']) {
                await this['pool']['end']();
            } else if (this['dbType'] === 'mysql' && this['mysqlConn']) {
            ...
            console['error']('❌\x20Close\x20failed:', _0x4aa853['message']);
        }
    }
}
