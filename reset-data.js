import _0x0_0x26522c from 'fs';
import _0x0_0x91d09f from 'path';
const DATA_DIR = _0x0_0x91d09f['join'](process['cwd'](), 'data');
const defaults = {
...
if (!_0x0_0x26522c['existsSync'](DATA_DIR))
    _0x0_0x26522c['mkdirSync'](DATA_DIR, { 'recursive': !![] });
for (const [file, value] of Object['entries'](defaults)) {
    const filePath = _0x0_0x91d09f['join'](DATA_DIR, file);
    _0x0_0x26522c['writeFileSync'](filePath, JSON['stringify'](value, null, 0x2));
