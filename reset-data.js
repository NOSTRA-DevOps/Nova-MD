import _0x0_0x4ab7d7 from 'fs';
import _0x0_0x499254 from 'path';
const DATA_DIR = _0x0_0x499254['join'](process['cwd'](), 'data');
const defaults = {
...
if (!_0x0_0x4ab7d7['existsSync'](DATA_DIR))
    _0x0_0x4ab7d7['mkdirSync'](DATA_DIR, { 'recursive': !![] });
for (const [file, value] of Object['entries'](defaults)) {
    const filePath = _0x0_0x499254['join'](DATA_DIR, file);
    _0x0_0x4ab7d7['writeFileSync'](filePath, JSON['stringify'](value, null, 0x2));
