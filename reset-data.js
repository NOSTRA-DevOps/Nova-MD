import _0x0_0x1fc866 from 'fs';
import _0x0_0x6b7827 from 'path';
const DATA_DIR = _0x0_0x6b7827['join'](process['cwd'](), 'data');
const defaults = {
...
if (!_0x0_0x1fc866['existsSync'](DATA_DIR))
    _0x0_0x1fc866['mkdirSync'](DATA_DIR, { 'recursive': !![] });
for (const [file, value] of Object['entries'](defaults)) {
    const filePath = _0x0_0x6b7827['join'](DATA_DIR, file);
    _0x0_0x1fc866['writeFileSync'](filePath, JSON['stringify'](value, null, 0x2));
