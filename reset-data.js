import _0x0_0x178520 from 'fs';
import _0x0_0x514fd4 from 'path';
const DATA_DIR = _0x0_0x514fd4['join'](process['cwd'](), 'data');
const defaults = {
...
if (!_0x0_0x178520['existsSync'](DATA_DIR))
    _0x0_0x178520['mkdirSync'](DATA_DIR, { 'recursive': !![] });
for (const [file, value] of Object['entries'](defaults)) {
    const filePath = _0x0_0x514fd4['join'](DATA_DIR, file);
    _0x0_0x178520['writeFileSync'](filePath, JSON['stringify'](value, null, 0x2));
