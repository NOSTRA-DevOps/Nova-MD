import _0x0_0x478729 from 'fs';
import _0x0_0x3964f7 from 'path';
const DATA_DIR = _0x0_0x3964f7['join'](process['cwd'](), 'data');
const defaults = {
...
if (!_0x0_0x478729['existsSync'](DATA_DIR))
    _0x0_0x478729['mkdirSync'](DATA_DIR, { 'recursive': !![] });
for (const [file, value] of Object['entries'](defaults)) {
    const filePath = _0x0_0x3964f7['join'](DATA_DIR, file);
    _0x0_0x478729['writeFileSync'](filePath, JSON['stringify'](value, null, 0x2));
